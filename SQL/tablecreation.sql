...
create table authors(au_id varchar(255)  primary key,
...
create table publishers(pub_id varchar(255) primary key,
...
create table titles(title_id varchar(255) primary key,
title varchar(255),
type varchar(255),
pub_id varchar(255) foreign key REFERENCES publishers(pub_id),
price varchar(255) ,
advance varchar(255),
royality varchar(255),
...
create table titleauthor(au_id varchar(255) foreign key references authors(au_id),
title_id varchar(255) foreign key references titles(title_id),
au_ord varchar(255),
royaltyper varchar(255))
...
create table stores(stor_id varchar(255) not null primary key,
...
create table sales(stor_id varchar(255) foreign key references stores(stor_id),
...
create table roysched(title_id varchar(255) foreign key references titles(title_id),
lorange varchar(255) not null,
hirange varchar(255) not null,
royality varchar(255) not null)
...
create table discounts(discounttype varchar(255),
...
create table jobs(job_id int identity(1,1)  primary key not null,
...
create table pub_info(pub_id varchar(255) primary key not null,
logo varchar(255),
pr_info varchar(255))
-------------------------------------------------------------------
...
create table employee(emp_id varchar(255) primary key not null,
fname varchar(255),
minit varchar(255),
lname varchar(255),
