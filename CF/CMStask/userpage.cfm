    ...
    <html>
		...
		<cfif editMode>
            ...
            <cfif isdefined("form.submit")>
                <cfif url.role EQ "admin" AND url.pageid EQ "#getRecord.pageid#">
                ...
                <cfelseif url.role EQ "editor" AND url.pageid EQ "#getRecord.pageid#">
                    <cfset obj3 = createObject("component","project.CMStask.edit") />
                    <cfset result=obj3.updatefunction(pagename=form.pagename,pagedesc=form.pagedesc)/>
