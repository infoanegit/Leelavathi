		...
		<div class="container mt-3 text-center adminpage">
			...
			<table class="table">
				...
				<tr>
					...
					<th>update</th>
					<cfelseif session.role EQ "admin">
					<th>update</th>
					<th>Delete</th>
					</cfif>
				</tr>
				...
				<tbody class="table-dark">
					<cfoutput query="myData">
						<tr>
							...
							<td><button class="btn btn-info"><a href="userpage.cfm?pageid=#myData.pageid#" target="_blank">Edit</button></td></a>
								<cfelseif session.role EQ "admin">
			...
			<cfparam name="session.role" default="">
			<cfif session.role EQ "Editor">
			<a href="userpage.cfm?session.role=user" target="_blank"><button class="btn btn-dark">Addnew</button></a>
			<cfelseif session.role EQ "admin">
			<a href="userpage.cfm?session.role=user" target="_blanck"><button class="btn btn-dark">Addnew</button></a>
			</cfif>
